...
from chemistry import make_periodic_table, compute_molar_mass, get_formula_name
...
def test_get_formula_name():
    ...
    result_known = get_formula_name("Al2O3", known_molecules_dict)
   
    assert result_known == "aluminum oxide"
